...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    bookingImages: json["booking_images"] == null ? [] : List<String>.from(json["booking_images"]!.map((x) => x)),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "booking_images": bookingImages == null ? [] : List<dynamic>.from(bookingImages!.map((x) => x)),
  };
}
